...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        eff_add_n1, eff_rem_n1 = set(node_a1.action.effect_add), set(node_a1.action.effect_rem)
        eff_add_n2, eff_rem_n2 = set(node_a2.action.effect_add), set(node_a2.action.effect_rem)

        return (eff_add_n1 & eff_rem_n2) | (eff_add_n2 & eff_rem_n2)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        pos_n1, neg_n1 = set(node_a1.action.precond_pos), set(node_a1.action.precond_neg)
        pos_n2, neg_n2 = set(node_a2.action.precond_pos), set(node_a2.action.precond_neg)
        add_n1, rem_n1 = set(node_a1.action.effect_add), set(node_a1.action.effect_rem)
        add_n2, rem_n2 = set(node_a2.action.effect_add), set(node_a2.action.effect_rem)

        return (add_n1 & neg_n2) | (rem_n1 & pos_n2) | (add_n2 & neg_n1) | (rem_n2 & pos_n1)
